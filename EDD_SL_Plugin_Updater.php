...
class EDD_SL_Plugin_Updater {
    ...
    public function init() {
        ...
        //add_filter( 'init', array( $this, 'check_update' ) );
    ...
    private function api_request( $_action, $_data ) {
        ...
        $api_params = array(
            ...
            'slug'       => $data['slug'],
            'author'     => $data['author'],
            /*'url'        => 'http://dev.wpmarket.com',
            'user-agent'  => 'WordPress/' . $wp_version . '; ' . get_bloginfo( 'url' ),*/
        );
        $request = wp_remote_post( $this->api_url, array( 'timeout' => 150, 'sslverify' => false, 'body' => $api_params ) );
