...
class AmazonECS
{
  ...
  public function search($pattern = '*', $nodeId = null)
  {
    ...
    if (!empty($this->requestConfig['title'])) $advanced_options['Title'] = $this->requestConfig['title'];
    //$advanced_options['MerchantId'] = 'Amazon';
    //echo $advanced_options['MerchantId'];
    //$advanced_options['Power'] = 'binding:not kindle';
    //$advanced_options['Power'] = 'binding: not free';
    // DM
    $dm = array(
        'Keywords' => $pattern,
    ...
    //echo 'ecs'; var_dump($advanced_options);
...
/* Modifications for title search support*/

public function title($title = null)
  {
    if (null === $title)
    {
      return $this->requestConfig['title'];
    }

    $this->requestConfig['title'] = $title;
  ...
  */
  ...
  protected function performSoapRequest2($function, $params)
  {
    ...
    proso_pre_print_r($returned_result);
    echo "-----------";
