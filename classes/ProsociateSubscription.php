...
class ProsociateSubscription {
    ...
    public function defaults() {
        ...
        $this->post_options['postchild'] = 'postchild';
    }
    ...
    public function search($asinLists = null) {
        ...
        $this->search->set_advanced_options($minPrice, $maxPrice, $this->options['availability'], $this->options['condition'], $this->options['manufacturer'], $this->options['brand'], $this->options['merchantid'], $this->options['minpercentageoff'],$this->options['item_title']);
    ...
    public function post() {
        $poster = new ProssociatePoster($this, true);
    ...
    public function save() {
        ...
        {
            // Insert new data
            $query = "INSERT INTO ".$wpdb->prefix.PROSSOCIATE_PREFIX."prossubscription
        ...
        else
        {
            ...
            $query = "UPDATE ".$wpdb->prefix.PROSSOCIATE_PREFIX."prossubscription
                        SET `name` = '%s',
                        `options` = '%s',
                        `search_results` = '%s',
                        `post_options` = '%s',
    ...
    public function load( $id = null ) {
        ...
        $query = "SELECT * FROM " . $wpdb->prefix . PROSSOCIATE_PREFIX . "prossubscription
            WHERE `id` = '%d'";
        ...
        if( ! $result )
        {
            update_option('prosCronSubsId', 'false');
    ...
    public function dbdelete( $id ) {
        ...
        $query = "DELETE FROM " . $wpdb->prefix . PROSSOCIATE_PREFIX . "prossubscription
            WHERE `id` = '%d'";
    ...
    public function getAssociatedPosts($campaignId) {
        ...
        // Select the campaign with the id = $this->id = $id
        $query = "SELECT associated_posts FROM " . $wpdb->prefix . PROSSOCIATE_PREFIX . "prossubscription
            WHERE `id` = '%d'";
