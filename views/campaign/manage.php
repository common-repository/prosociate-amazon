...
<h2>
	Prosociate: Manage <?php echo $headTitle; ?><a href="admin.php?page=<?php echo $actionUrl; ?>" class="add-new-h2">Add New</a></h2>
</h2>
						...
						switch( $column_id ):
							...
							case 'name':
								...
								<td class='post-title page-title column-title'>
									<strong>
										<a class="row-title" href="admin.php?page=<?php echo $actionUrl; ?>&campaign_id=<?php echo $campaign->id; ?>" title="Edit this campaign"><?php echo $campaign->name; ?></a>
									</strong>

									<div class="row-actions">
										<span class='edit'><a href="admin.php?page=<?php echo $actionUrl; ?>&campaign_id=<?php echo $campaign->id; ?>" title="Edit this campaign">Edit</a> | <span class='trash'><a class='submitdelete' title='Delete Campaign' href='admin.php?page=<?php echo $linkUrl; ?>&action=delete&campaign_id=<?php echo $campaign->id; ?>'>Delete</a>
									</div>
								</td>
								<?php
								break;
