...
<div style='' class="dm-tab-search" xmlns="http://www.w3.org/1999/html">
    ...
    <div id="dmPros_advanceSearch" style="display:none; margin-top:10px;">
        ...
        <input style="display: none; margin-right: 5px;" type="checkbox" name="dmAmazonOnly" id="dmAmazonOnly" value="true"/>
        <input type="hidden" id="dmAmazonOnlyCheck" name="dmAmazonOnlyCheck" value=""/>
        <input type="checkbox" name="useasinlists" id="useasinlists" value="useasinlists" style="display: none; margin-right: 3px;"<?php echo $useasinlists; ?>/>
        <textarea rows="10" cols="65" style="display: none; margin-left:13px; margin-top:5px; border-color: #000000;" id="dmasinlists" name="dmasinlists"><?php echo $dmAsinLists; ?></textarea>
    </div>
    <br /><br />
