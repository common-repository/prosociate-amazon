...
<h3 style="display: none;">Post Dates</h3>
    ...
    <tr valign="top" class="">
        ...
        <td class="forminp">
            <fieldset>
                ...
                <label for="date_type_specific">All Products Have The Specified Post Date</label> <input type="text" class="datepicker" name="post_options[date]" value="<?php echo $campaign->post_options['date']; ?>" style="width: 150px;"/>
                ...
                <div style='padding-top: 6px;'><input type="text" class="datepicker" name="post_options[date_start]" value="<?php echo $postDateStart; ?>" /> and
                    <input type="text" class="datepicker" name="post_options[date_end]" value="<?php echo $postDateEnd; ?>" /></div>
    ...
    <tr valign="top" class="">
        ...
        <td class="forminp">
            ...
            <div id="poststuff" class="metabox-holder" style="display: <?php echo $dmDisplay; ?>;">
                <?php $meta_boxes = do_meta_boxes('prosociate_page_pros-subscription', 'side', $test_object = ''); ?>
            </div>
...
<table class="form-table">
    ...
    <tr valign="top" class="">
        <th scope="row" class="titledesc">Shopping Cart Disabled</th>
        <td class="forminp">
            <input type="checkbox" name="dmAutoAffiliate" id="dmAutoAffiliate" value="true" checked="checked"/> <label for="dmAutoAffiliate">Automatically post product as external / affiliate when they can't be added to the shopping cart.</label>
            <input type="hidden" id="dmAutoAffiliateCheck" name="dmAutoAffiliateCheck" value="true"/>
...
<div class="dm-campaign-post-button dm-hide-first" style="display:none;">
    <input style="font-size: 14px;" class="wp-core-ui button-primary dm-save-campaign-button" type='button' name='pros_save_submit_post' value='Create Product Posts' /><br />
    <!-- Yuri -->
</div>