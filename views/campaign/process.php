<div class="wrap">
    <div class="dm-process-wrap">
        ...
        <div style='font-style: italic;'>
            ...
            if(isset($this->campaign->options["dmasinlists"]) && !empty($this->campaign->options["dmasinlists"])) {
                ...
                $filtered_count = count($tempContainerArray);

                update_option('dm_temp_number', $filtered_count);
            }
            ?>
        </div>
        <div id="dm-process">
